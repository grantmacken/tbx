...
| harper-ls               | 1.2.0    | 'Harper Language Server Grammar Checker'                                              |
| lua-language-server     | 3.15.0   | 'Lua language server'                                                                 |
| tombi                   | v0.7.7   | "TOML Formatter                                                                       |
| mbake                   | v1.4.3   | Makefile formatter and linter                                                         |
| bash-language-server    | 5.6.0    | A language server for Bash                                                            |
| copilot                 | 0.0.369  | GitHub Copilot CLI brings the power of Copilot coding agent directly to your terminal. |
| copilot-language-server | 1.405.0  | Your AI pair programmer                                                               |
