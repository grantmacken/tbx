...
| rebar3                  | 3.25.1   | Tool for working with Erlang projects                                                 |
| elixir                  | 1.19.4   | A modern approach to programming for the Erlang VM                                    |
| gleam                   | 1.14.0   | Gleam programming language                                                            |
| golang                  | 1.25.5   | The Go Programming Language                                                           |
| nodejs                  | 22.20.0  | JavaScript runtime                                                                    |
| uv                      | 0.9.17   | An extremely fast Python package installer and resolver, written in Rust              |
...
| harper-ls               | 1.3.0    | 'Harper Language Server Grammar Checker'                                              |
| lua-language-server     | 3.15.0   | 'Lua language server'                                                                 |
| tombi                   | v0.7.12  | "TOML Formatter                                                                       |
| mbake                   | v1.4.4   | Makefile formatter and linter                                                         |
| bash-language-server    | 5.6.0    | A language server for Bash                                                            |
| copilot                 | 0.0.372  | GitHub Copilot CLI brings the power of Copilot coding agent directly to your terminal. |
| copilot-language-server | 1.406.0  | Your AI pair programmer                                                               |
