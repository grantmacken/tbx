...
| ----                    | -------  | -------                                                                               |
| gh                      | 2.100.0  | GitHub\xe2\x80\x99s official command line tool.                                       |
...
| Name                    | Version  | Summary                                                                               |
| ----                    | -------  | -------                                                                               |
| erlang                  | OTP-29.0.6 | General-purpose programming language and runtime environment                          |
...
| pi-coding-agent         | 0.85.1   | minimal agent harness                                                                 |
